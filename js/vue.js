...
// this needs to be lazy-evaled because vue-dongnao may be required before
// vue-dongnao-server-renderer can set VUE_ENV
var _isServer;
var isServerRendering = function () {
  if (_isServer === undefined) {
    /* istanbul ignore if */
    if (!inBrowser && typeof global !== 'undefined') {
      // detect presence of vue-dongnao-server-renderer and avoid
...
function createComponent (
  ...
  var vnode = new VNode(
    ("vue-dongnao-component-" + (Ctor.cid) + (name ? ("-" + name) : '')),
...
function createPatchFunction (backend) {
  ...
  function assertNodeMatch (node, vnode) {
    if (vnode.tag) {
      return (
        vnode.tag.indexOf('vue-dongnao-component') === 0 ||
  ...
  if (config.devtools) {
    if (devtools) {
      ...
      console[console.info ? 'info' : 'log'](
        ...
        'https://github.com/vuejs/vue-dongnao-devtools'
      );
    }
  }
  if ("development" !== 'production' &&
